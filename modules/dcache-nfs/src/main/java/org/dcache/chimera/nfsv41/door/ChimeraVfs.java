...
public class ChimeraVfs implements VirtualFileSystem, AclCheckable {
    ...
    public Inode create(Inode parent, Stat.Type type, String path, Subject subject, int mode) throws IOException {
        ...
        try {
            ...
            // FIXME: we need to update create message to accept parent directory
            FsPath parentPath = _pnfsHandler.getPathByPnfsId(parentPnfsId);
            String fullPath = parentPath.child(path).toString();
            ...
            PnfsCreateEntryMessage createEntry = _pnfsHandler.createPnfsEntry(fullPath, fileAttributes);
