...
public class BillingStartupMessageSerializer implements Serializer<MoverStartupInfoMessage> {

    static JSONObject transform(MoverStartupInfoMessage data) {
    ...
    @Override
    public byte[] serialize(String topic, MoverStartupInfoMessage data) {
