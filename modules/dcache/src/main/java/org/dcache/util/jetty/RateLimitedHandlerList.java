...
public class RateLimitedHandlerList extends HandlerCollection implements CellCommandListener {
    ...
    /**
     * Maximum capacity of the client IP rates limiters map size.
     */
    private final long MAX_CLIENT_IP_CACHE_SIZE = 1024*10;


    /**
     * Maximum number of blocked clients.
     */
    private final long MAX_BLOCKED_CLIENT_IP_CACHE_SIZE = 1024*1024;
