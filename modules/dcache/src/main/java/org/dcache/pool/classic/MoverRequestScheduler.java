...
public class MoverRequestScheduler implements Runnable {
     ...
     * @param doorUniqueueRequest unique request identifier generated by the door.
     * @param priority
     * @return mover id
     */
    public synchronized int getOrCreateMover(MoverSupplier moverSupplier, String doorUniqueueRequest, IoPriority priority) throws CacheException {
        checkState(!_shutdown);

        PrioritizedRequest request = _moverByRequests.get(doorUniqueueRequest);
        if(request != null) {
        ...
        request = new PrioritizedRequest(id, doorUniqueueRequest, mover, priority);
        ...
        _moverByRequests.put(doorUniqueueRequest, request);
