...
public class IoQueueManager {
    ...
    public int getOrCreateMover(String queueName, String requestUniqueId, MoverSupplier moverSupplier, IoPriority priority) throws CacheException
    {
        return getQueueByNameOrDefault(queueName).getOrCreateMover(moverSupplier, requestUniqueId, priority);
    }
