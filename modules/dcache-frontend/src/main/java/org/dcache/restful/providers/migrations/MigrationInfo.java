...
@Schema(description = "Container for migration information regarding a pool.")
public class MigrationInfo {
    private static final long serialVersionUID = -7942464845703567335L;

    @Schema(description = "Current state of the migration.")
    private String state;

    @Schema(description = "Number of queued PNFSIDs.")
    private Integer queued;

    @Schema(description = "Number of attempts.")
    private Integer attempts;

    @Schema(description = "List of target pools for the migration.")
    private List<String> targetPools;

    @Schema(description = "Number of completed files, bytes and a percentage (if not finished or failed). (X files; Y bytes; Z%)")
    private String completed;

    @Schema(description = "Number of total bytes.")
    private Integer total;

    @Schema(description = "Representation of the running tasks for the migration job.")
    private String runningTasks;

    @Schema(description = "Representation of the most recent errors for the migration job.")
